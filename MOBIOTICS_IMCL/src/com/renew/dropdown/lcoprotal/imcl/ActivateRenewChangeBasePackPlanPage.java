...
public class ActivateRenewChangeBasePackPlanPage extends BasePage {

    public ActivateRenewChangeBasePackPlanPage() 
    {
    ...
    private List<WebElement> isRadioButtonsArePresentInChangeValidtyPage;
    ...
    public void EnterCanNumberToChangeBasePack_Validity() throws InterruptedException {
    	...
    	List<WebElement> list = isRadioButtonsArePresentInChangeValidtyPage;
    	 ...
    	 boolean isCheckBoxChecked=false;
			for(WebElement elements :list) {
				...
				Thread.sleep(2000);
    	 		...
    	 		WebElement reasonForTheStatus= showTheReasonforTheStatus;
    	 		
    	 		Thread.sleep(2000);
    	 		System.out.println("The Status Of the Plan for change validity is "+showTheStatus.getText()+ 
    	 				            " and The Reason is " + reasonForTheStatus.getText()); }
    	 	
    	 	    else if(isRadioButtonsArePresentInChangeValidtyPage.isEmpty() && showThisErrorMsg.isDisplayed()) {
