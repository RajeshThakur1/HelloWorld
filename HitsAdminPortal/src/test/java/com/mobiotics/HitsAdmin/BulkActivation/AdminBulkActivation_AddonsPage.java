...
public class AdminBulkActivation_AddonsPage extends BasePage 
{
  public AdminBulkActivation_AddonsPage()
  {
  ...
  private String bulkfile = "C:\\Users\\sande\\Desktop\\AutoITforHITS\\AdminbulkAddon.exe";

  public void bulkProductSubscription_AddonTest() throws IOException, InterruptedException
  {
	  fileUpload.click();
	  Thread.sleep(5000);
