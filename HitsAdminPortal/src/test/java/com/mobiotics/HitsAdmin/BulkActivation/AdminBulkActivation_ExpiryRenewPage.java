...
public class AdminBulkActivation_ExpiryRenewPage extends BasePage
{
	public AdminBulkActivation_ExpiryRenewPage() 
	{
	 ...
	 @FindBy(id="productsubscriptionselect")
	  ...
	  private String bulkfile = "C:\\Users\\sande\\Desktop\\AutoITforHITS\\Adminbulkexpiryrenew.exe";

	  public void bulkProductSubscription_ExpiryRenewTest() throws IOException, InterruptedException
	  {
		  fileUpload.click();
		  Thread.sleep(5000);
